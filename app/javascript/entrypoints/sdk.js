...
const runSDK = ({ baseUrl, websiteToken }) => {
  ...
  window.$chatwoot = {
    ...
    welcomeTitle: chatshippoSettings.welcomeTitle || '',
    welcomeDescription: chatshippoSettings.welcomeDescription || '',
    availableMessage: chatshippoSettings.availableMessage || '',
    unavailableMessage: chatshippoSettings.unavailableMessage || '',
    enableFileUpload: chatshippoSettings.enableFileUpload,
    enableEmojiPicker: chatshippoSettings.enableEmojiPicker ?? true,
    enableEndConversation: chatshippoSettings.enableEndConversation ?? true,
