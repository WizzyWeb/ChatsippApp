export default {
  ...
  DOCS_URL: '//www.chatshippo.com/docs/product/',
  HELP_CENTER_DOCS_URL: '//www.chatshippo.com/docs/product/others/help-center',
  TESTIMONIAL_URL: 'https://testimonials.cdn.chatshippo.com/content.json',
